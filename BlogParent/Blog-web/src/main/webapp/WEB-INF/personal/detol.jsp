...
<head>
    ...
    <title>文章阅读</title>
    <link rel="stylesheet" href="${ctx}/static3/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="${ctx}/layui/css/layui.css">
    <link rel="stylesheet" href="${ctx}/static3/css/master.css">
    <link rel="stylesheet" href="${ctx}/static3/css/gloable.css">
    <link rel="stylesheet" href="${ctx}/static3/css/nprogress.css">
    <link rel="stylesheet" href="${ctx}/static3/css/blog.css">
    <link id="layuicss-layer" rel="stylesheet" href="http://www.jq22.com/demo/layuibokemoban202007162358/layui/css/modules/layer/default/layer.css?v=3.1.1" media="all"></head>
<body>
<div class="header">
</div>
        ...
        <div class="header-inner">
            ...
            <nav class="nav" id="nav">
                <ul>
                    ...
                    <li class=""><a href="article.html">博客</a></li>
                    <li class=""><a href="message.html">留言</a></li>
                    <li class=""><a href="diary.html">日记</a></li>
    ...
    <div class="footer-fixed">
        <div class="copyright">
            <div class="info">
                ...
                <p class="mt05">
                    Copyright © 2019-2020 ZQ博客 All Rights Reserved V.3.1.3 Power by ZQ博客
                </p>
            </div>
        </div>
    </div>
...
<script src="${ctx}/static3/js/yss/gloable.js"></script>
<script src="${ctx}/static3/js/nprogress.js"></script>
<script src="${ctx}/static3/js/pagecomment.js"></script>
...
<ul class="layui-fixbar"><li class="layui-icon layui-fixbar-top" lay-type="top" style=""></li></ul></body>
</html>
