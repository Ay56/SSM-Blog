...
<section class="container-fluid">
    ...
    <div class="row">
        <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li class="active"><a href="${ctx}/article?id=${user.id}">文章</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            <div class="row">
                <form action="${ctx}/update?id=${user.id}"  id="blog_form" method="post" class="add-article-form" enctype="multipart/form-data">
                    <div class="col-md-9">
                        <h1 class="page-header">撰写新文章</h1>
                        <div class="form-group">
                            <label for="article-title" class="sr-only">标题</label>
                            <input type="text" id="article-title" name="title" class="form-control" value="${update.title}">
                        </div>
                        <div class="form-group">
                            <label for="article-content" class="sr-only">内容</label>
                            <div id="article-content" name="content" ></div>
                            <input type="hidden" value="${update.content}" id="resContent">
                        </div>
                    ...
                    <div class="col-md-3">
                                ...
                                <ul class="category-list">
                                    ...
                                    <li>
                                        <label>
                                            ...
                                            美食梦 <em class="hidden-md">( 栏目ID: <span>6</span> )</em></label>
                                    </li>
                                    <li>
                                        <label>
                                            <input name="category" type="radio" value="动物梦">
                                            动物梦 <em class="hidden-md">( 栏目ID: <span>7</span> )</em></label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <input type="text" class="form-control" placeholder="输入新标签" name="titleName" required="" value="${update.titleName}">
                                <span class="prompt-text">多个标签请用英文逗号,隔开</span> </div>
                        </div>
                        <div class="add-article-box">
                            <h2 class="add-article-box-title"><span>标题图片</span></h2>
                            <div class="add-article-box-content" id="imageSize">
                                <img src="${ctx}/uploads/${update.titlePic}" id="imageview" class="item_img" >
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <p><label>状态：</label>
                            <c:if test="${update.personal eq '0'}">
                            <span class="article-status-display" >未发布</span>
                            </c:if>
                            <c:if test="${update.personal eq '1'}">
                            <span class="article-status-display">已发布</span>
                            </c:if>
                                </p>
                                <p><label>公开度：</label><input type="radio" name="personal" value="0" checked/>公开 <input type="radio" name="personal" value="1" />加密</p>
                                <p><label>发布于：</label><span class="article-time-display"><input  type="text" name="rptTime"  value="<fmt:formatDate value="${update.rptTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" id="test1" /></span></p>
                            </div>
                            <input type="hidden" name="titlePic" value="${update.titlePic}">
                            <input type="hidden" name="updateId" value="${update.id}">
                            <div class="add-article-box-footer">
                                <button class="btn btn-primary" type="button"  id="send">修改</button>
                            </div>
                        </div>
                    </div>
                </form>
...
$(function () {
    ...
    editor.ready(function () {
        editor.execCommand("inserthtml",$("#resContent").val());
    });
