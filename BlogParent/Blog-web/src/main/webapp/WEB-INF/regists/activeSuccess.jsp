...
<head>
    ...
    <link href="${ctx}/static/css/bootstrap/css/bootstrap-theme.min.css" rel="stylesheet"/>
...
<div class="active-head">
    <div style="line-height: 44px;margin-left: 5px">
        <span style="color: white;font-family: Arial;font-size: 18px">激活成功</span>
    </div>
    <div class="content">
        ...
        <div style="margin-left: 340px"> <span style="font-size: 17px;">您登陆的用户名为：<span style="color: green;font-weight: bold">${email}</span></span></div>
    ...
    <div class="foot" style="position: absolute;left: 280px;float: left;margin-top: 40px">
        <div class="foot-nav clearfix">
            ...
            <div class="foot-nav-col">
                ...
                <ul>
                    <li>
                        <a href="http://#" onMouseOut="hideImg()"  onmouseover="showImg()">
                            微信
                            <div id="wxImg" style="display:none;height:50px;back-ground:#f00;position:absolute;">
                                <img src="/static/images/dreamland.png"/><br/>
                                手机扫描二维码关注
                            </div>
        ...
        <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 40px;text-align: center">
            <div class="foot-copyrights" style="margin-left: 200px">
                <p>
                    互联网ICP备案：京ICP备565689号-1
                </p>
                <p>
                    <span>违法和不良信息举报电话：010-8576098</span>
                    <span>邮箱：96281975@qq.com</span>
                </p>
                <p style="margin-top: 8px">&copy; 源哥版权所有</p>
            </div>
        </div>
...
<script type="text/javascript" src="${ctx}/static/css/bootstrap/js/bootstrap.min.js"></script>
