...
<head>
    <meta charset="UTF-8">
    <title>注册</title>
    <meta name="keywords" content="源哥网">
    <meta name="content" content="源哥网">
    <meta name="viewport" content="width=device-width,initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
    <meta http-equiv="X-UA-Compatible" content="IE=edge, chrome=1">
    <link type="text/css" rel="stylesheet" href="${ctx}/static/css/dreamland.css">
    <script type="text/javascript" src="${ctx}/static/js/jquery.min.js"></script>
    <script type="text/javascript" src="${ctx}/static/images/lib/js/jquery.min.js"></script>
</head>
        ...
        <div class="zc">
            <div class="bj_bai" id="regist-left" style="height: 468px">
                ...
                <form action="${ctx}/doRegister" method="post" id="registerForm">
                    ...
                    <div>
                        <input id="protocol" type="checkbox" onclick="checkProtocol();"><span>已阅读并同意<a href="#" target="_blank" ><span class="lan">《源哥协议》</span></a></span>
                        <br/>
...
<script type="text/javascript">
    ...
    $("#to_register").click (function(){
        if(!checkProtocol()){
            $("#protocol_span").text("请勾选\"阅读并接受源哥协议\"！").css("color","red");
        }else{
            $("#protocol_span").text("");
        }
